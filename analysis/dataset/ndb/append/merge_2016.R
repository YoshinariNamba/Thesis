...
### read csv
df_ndb_o_2016_in <- read_csv("../arranged/2016/ndb_o_2016_in.csv", 
  ...
  mutate(total_in = as.numeric(str_replace_all(.$total_in, pattern = ",", replacement = "")), 
         form = "oral")
df_ndb_o_2016_out <- read_csv("../arranged/2016/ndb_o_2016_out.csv", 
                              locale = locale(encoding = "Shift-JIS")) %>% 
  rename(code_receipt = 1, 
         name = 2, 
         unit = 3, 
  ...
  mutate(total_out = as.numeric(str_replace_all(.$total_out, pattern = ",", replacement = "")), 
         form = "oral")
df_ndb_o_2016_hos <- read_csv("../arranged/2016/ndb_o_2016_hos.csv", 
                              locale = locale(encoding = "Shift-JIS")) %>% 
  rename(code_receipt = 1, 
         name = 2, 
         unit = 3, 
...
### read csv
df_ndb_p_2016_in <- read_csv("../arranged/2016/ndb_p_2016_in.csv", 
                             locale = locale(encoding = "Shift-JIS")) %>% 
  rename(code_receipt = 1, 
         name = 2, 
         unit = 3, 
  ...
  mutate(total_in = as.numeric(str_replace_all(.$total_in, pattern = ",", replacement = "")), 
         form = "parenteral")
df_ndb_p_2016_out <- read_csv("../arranged/2016/ndb_p_2016_out.csv", 
                              locale = locale(encoding = "Shift-JIS")) %>% 
  rename(code_receipt = 1, 
         name = 2, 
         unit = 3, 
  ...
  mutate(total_out = as.numeric(str_replace_all(.$total_out, pattern = ",", replacement = "")), 
         form = "parenteral")
df_ndb_p_2016_hos <- read_csv("../arranged/2016/ndb_p_2016_hos.csv", 
                              locale = locale(encoding = "Shift-JIS")) %>% 
  rename(code_receipt = 1, 
         name = 2, 
         unit = 3, 
...
### read csv
df_ndb_t_2016_in <- read_csv("../arranged/2016/ndb_t_2016_in.csv", 
                             locale = locale(encoding = "Shift-JIS")) %>% 
  rename(code_receipt = 1, 
         name = 2, 
         unit = 3, 
  ...
  mutate(total_in = as.numeric(str_replace_all(.$total_in, pattern = ",", replacement = "")), 
         form = "topical")
df_ndb_t_2016_out <- read_csv("../arranged/2016/ndb_t_2016_out.csv", 
                              locale = locale(encoding = "Shift-JIS")) %>% 
  rename(code_receipt = 1, 
         name = 2, 
         unit = 3, 
  ...
  mutate(total_out = as.numeric(str_replace_all(.$total_out, pattern = ",", replacement = "")), 
         form = "topical")
df_ndb_t_2016_hos <- read_csv("../arranged/2016/ndb_t_2016_hos.csv", 
                              locale = locale(encoding = "Shift-JIS")) %>% 
  rename(code_receipt = 1, 
         name = 2, 
         unit = 3, 

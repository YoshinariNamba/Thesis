...
# read
df_shusai_o_2016 <- read_csv(file = "../arranged/2016/shusai_o_2016.csv", 
                             locale = locale(encoding = "Shift-JIS"))

df_shusai_p_2016 <- read_csv(file = "../arranged/2016/shusai_p_2016.csv", 
                             locale = locale(encoding = "Shift-JIS"))

df_shusai_t_2016 <- read_csv(file = "../arranged/2016/shusai_t_2016.csv", 
                             locale = locale(encoding = "Shift-JIS"))
